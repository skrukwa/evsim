...
import cluster
import visuals
from classes import ChargeStation, _Leg, ChargeNetwork
...
def mutate_legs(legs: set[_Leg], gmaps: googlemaps.client.Client) -> None:
    """
...
def _mutate_leg(leg: _Leg, gmaps: googlemaps.client.Client) -> bool:
    """
